...
<template>
  <div class="max-w-4xl mx-auto p-6 space-y-8">
    <div v-if="isLoading" class="text-center text-gray-700 font-semibold">
      Loading , please wait...
    </div>

    <div v-else-if="!isAuthorized" class="text-center text-red-600 font-bold">
      Access denied. Redirecting to login...
    </div>

    <div v-else>
      <form
        class="flex flex-col space-y-4 bg-white p-6 rounded-lg shadow-lg"
        @submit="addTask"
      >
        <input
          type="text"
      ...
      <div class="space-y-4 mt-8">
        ...
        >
          ...
          <h2
            class="text-sm uppercase tracking-wider text-green-400 font-bold mb-1"
          >
            {{ task.state }}
          </h2>
